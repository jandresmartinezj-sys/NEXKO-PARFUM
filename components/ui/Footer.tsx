...
const SHOP_LINKS = [
  { href: "/tienda?cat=arabes", label: "Árabes & Orientales" },
  { href: "/tienda?cat=masculinos", label: "Masculinos" },
  { href: "/tienda?cat=femeninos", label: "Femeninos" },
  { href: "/tienda?cat=sets-regalo", label: "Sets & Kits" },
